...
function Settings(props) {
  ...
  return (
    <Box width={'80%'}>
      <Typography variant="body1">This plugin is in early development and is not yet ready for production use. Using it may incur
in costs from the AI provider! Use at your own risk.</Typography>
